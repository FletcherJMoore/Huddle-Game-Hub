// Lucide glyphs as small stroke-inheriting React components. Kept inline (rather
// than pulling lucide's DOM factory) so they compose naturally in JSX and take
...
function Svg({ size = 19, children, ...rest }) {
  return (
